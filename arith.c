...
/*****************************************************************
  ...
  LAST MODIFICATION DATE: 01.12.1993
...
{ 
  ...
  int igcd(),r,x,y1,y2,z1,z2,na,nb;
...
{ 
  ...
  int igcd(),r,x,y1,y2,z1,z2,an,bn;
...
int eqie_satisfied(iep,pp,n,ie)
int n,ie;
RAT *iep,*pp;
...
gauss_calcnewrow(row1,row2,pivcol,newrow,piv_remove,rowl)
RAT *row1,*row2,*newrow;
int pivcol,piv_remove,rowl;
...
void I_RAT_row_prim(old,new,p,n)
RAT *old,*new,*p;
int n;
